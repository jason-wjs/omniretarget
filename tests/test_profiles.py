...
from holosoma_retargeting.configs import motion as config_data_type
from holosoma_retargeting.configs.motion import MotionDataConfig
from holosoma_retargeting.configs import robot as config_robot
...
def test_config_motion_imports_alias_profile_objects() -> None:
...
def test_config_robot_defaults_alias_profile_object() -> None:
